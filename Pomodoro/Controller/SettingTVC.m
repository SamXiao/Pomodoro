...
- (IBAction)onDarkModeSwitchChanged:(UISwitch *)sender {
    NSString *bgMode = @"white";
    if ( sender.isOn ) {
        bgMode = @"black";
    }
    self.settings.bgMode = bgMode;
    NSLog( @"bgMode %@ has been set. ", bgMode);
}
